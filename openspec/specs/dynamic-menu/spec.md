...
The system SHALL provide a seed script that imports all existing routes from the current router configuration as initial sys_menu records with appropriate role assignments matching current access patterns.
