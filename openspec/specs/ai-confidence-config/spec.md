# ai-confidence-config

## Purpose

Configurable, explainable AI confidence scoring that drives warnings, fallback behavior, and manual-review requirements across AI-assisted quality features.
